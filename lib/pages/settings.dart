...
const Map<String, Map<String, String>> translations = {
  'English': {
    ...
    'trying': 'Searching streaming sources...',
    'justNow': 'Just now',
    'noUpdate': 'No Update',
    ...
    'forceUpdateMsg': 'A new version is available and required to continue.',
    'popular': 'Popular',
    'recent': 'Recent',
    'newDramas': 'New',
    'noDramaHistory': 'No drama watch history yet',
    'startWatchingDrama': 'Start watching dramas to build your history',
  },
  'Español': {
    ...
    'trying': 'Buscando fuentes de streaming...',
    'justNow': 'Ahora',
    ...
    'forceUpdate': 'Actualización Requerida',
    'forceUpdateMsg': 'Una nueva versión está disponible y es necesaria para continuar.',
    'popular': 'Popular',
    'recent': 'Reciente',
    'newDramas': 'Nuevo',
    'noDramaHistory': 'Sin historial de dramas',
    'startWatchingDrama': 'Empieza a ver dramas',
  },
  'Português': {
    ...
    'trying': 'Procurando fontes de streaming...',
    'justNow': 'Agora',
    ...
    'forceUpdate': 'Atualização Obrigatória',
    'forceUpdateMsg': 'Uma nova versão está disponível e é necessária para continuar.',
    'popular': 'Popular',
    'recent': 'Recente',
    'newDramas': 'Novo',
    'noDramaHistory': 'Sem histórico de dramas',
    'startWatchingDrama': 'Comece a assistir dramas',
  },
  '日本語': {
    'settings': '設定',
    'general': '一般',
    ...
    'forceUpdate': 'アップデートが必要です',
    'forceUpdateMsg': '新しいバージョンが利用可能です。続行するには更新してください。',
    'popular': '人気',
    'recent': '最近',
    'newDramas': '新着',
    'noDramaHistory': 'ドラマの視聴履歴がありません',
    'startWatchingDrama': 'ドラマの視聴を開始しましょう',
  },
  '中文': {
    'settings': '设置',
    'general': '通用',
    ...
    'forceUpdate': '需要更新',
    'forceUpdateMsg': '有新版本可用，需要更新才能继续。',
    'popular': '热门',
    'recent': '最近',
    'newDramas': '最新',
    'noDramaHistory': '暂无观看历史',
    'startWatchingDrama': '开始观看剧集吧',
  },
  'ไทย': {
    'settings': 'ตั้งค่า',
    'general': 'ทั่วไป',
    ...
    'tapToCheck': 'แตะเพื่อตรวจสอบเวอร์ชันล่าสุด',
    'appearance': 'ลักษณะ',
    'language': 'ภาษา',
    'theme': 'ธีม',
    'accentColor': 'สีเน้น',
    'content': 'เนื้อหา',
    'nsfwFilter': 'แสดงเนื้อหา NSFW',
    'nsfwSubtitle': 'แสดงอนิเมะสำหรับผู้ใหญ่',
    'playback': 'การเล่น',
    'autoRotate': 'หมุนอัตโนมัติ',
    'autoRotateSub': 'หมุนเป็นแนวนอนขณะเล่น',
    'videoQuality': 'คุณภาพวิดีโอ',
    'videoQualitySub': 'คุณภาพสตรีมที่ต้องการ',
    'preferredPlayer': 'เครื่องเล่นที่ต้องการ',
    'preferredPlayerSub': 'เลือกเครื่องเล่นวิดีโอ',
    'playerEngine': 'เอนจินเครื่องเล่น',
    'storage': 'พื้นที่จัดเก็บ',
    'clearCache': 'ล้างแคช',
    'clearCacheSub': 'ลบไฟล์ชั่วคราว',
    'clearHistory': 'ล้างประวัติการรับชม',
    'clearHistorySub': 'ลบตอนที่ดูแล้วทั้งหมด',
    'clearAllData': 'ล้างข้อมูลทั้งหมด',
    'clearAllDataSub': 'ลบคลัง ประวัติ และการตั้งค่า',
    'links': 'ลิงก์',
    ...
    'downloadInstall': 'ดาวน์โหลดและติดตั้ง',
    ...
    'ok': 'ตกลง',
    'cancel': 'ยกเลิก',
    'resumeFrom': 'กลับมาดูต่อจาก?',
    'startOver': 'ดูใหม่ตั้งแต่ต้น',
    'resume': 'กลับมาดูต่อ',
    'episode': 'ตอน',
    'schedule': 'กำหนดการ',
    'top': 'ยอดนิยม',
    ...
    'episodes': 'ตอน',
    'play': 'เล่น',
    'addToLibrary': 'เพิ่มลงคลัง',
    'removeFromLibrary': 'ลบจากคลัง',
    'search': 'ค้นหา',
    'genres': 'หมวดหมู่',
    ...
    'onHold': 'พักไว้',
    'dropped': 'เลิกดู',
    'planToWatch': 'วางแผนจะดู',
    'changeStatus': 'เปลี่ยนสถานะ',
    'noAnimeYet': 'ยังไม่มีอนิเมะในคลัง',
    'addAnimeHint': 'แตะไอคอนบุ๊กมาร์กบนอนิเมะเพื่อเพิ่ม',
    'watchHistory': 'ประวัติการรับชม',
    'episodesCount': 'ตอน',
    'noHistoryYet': 'ยังไม่มีประวัติการรับชม',
    'startWatching': 'เริ่มดูอนิเมะเพื่อสร้างประวัติ',
    'selectServer': 'เลือกเซิร์ฟเวอร์',
    'retryAll': 'ลองใหม่ทั้งหมด',
    'allFailed': 'เซิร์ฟเวอร์ทั้งหมดล้มเหลว',
    'loadingEpisode': 'กำลังโหลดตอน',
    'trying': 'กำลังค้นหาแหล่งสตรีม...',
    'justNow': 'เมื่อสักครู่',
    'noUpdate': 'ไม่มีการอัปเดต',
    'couldNotCheck': 'ไม่สามารถตรวจสอบได้ กรุณาเชื่อมต่ออินเทอร์เน็ต',
    'newVersion': 'มีเวอร์ชันใหม่',
    'currentVersion': 'เวอร์ชันปัจจุบัน',
    'couldNotLoad': 'ไม่สามารถโหลดรายละเอียดได้',
    'confirmClearHistory': 'ล้างประวัติการรับชมทั้งหมด?',
    'confirmClearData': 'จะลบคลัง ประวัติ และการตั้งค่าทั้งหมด',
    'forceUpdate': 'จำเป็นต้องอัปเดต',
    'forceUpdateMsg': 'มีเวอร์ชันใหม่และจำเป็นต้องอัปเดตเพื่อดำเนินการต่อ',
    'popular': 'ยอดนิยม',
    'recent': 'ล่าสุด',
    'newDramas': 'ใหม่',
    'noDramaHistory': 'ยังไม่มีประวัติการรับชม',
    'startWatchingDrama': 'เริ่มดูละครเพื่อสร้างประวัติ',
  },
};
